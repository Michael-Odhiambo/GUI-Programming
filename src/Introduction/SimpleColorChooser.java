...
/**
 * This program shows six sliders that the user can manipulate to set
 * the red, green, blue, hue, brightness, and saturation components of a
 * color. A color patch shows the selected color, and there are six labels
 * that show the numerical values of all the components.
 */
public class SimpleColorChooser extends Application {

    // Sliders to control the color components.
    private Slider hueSlider, brightnessSlider, saturationSlider, redSlider, greenSlider, blueSlider;

    // Labels for displaying the color component values.
    ...
    public void start( Stage stage ) {
        ...
        // The color patch occupies six rows.
    ...
    private void newColor( Slider whichSlider ) {
        ...
        String colorString = String.format( "#%02x%02x%02x", ( int ) ( 255 * color.getRed() ), ( int )( 255*color.getGreen() ),
        ...
        brightnessLabel.setText( String.format( " Saturation = %1.3f", color.getBrightness() ) );
