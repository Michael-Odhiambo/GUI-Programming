 ...
 * michaelallanodhiambo@gmail.com
 */
...
/**
 * This program displays information about mouse event on a canvas,
 * including the type of event, the position of the mouse, a list of modifier
 * keys that were down when the event occurred, and an indication of which
 * button was pressed or released, if any. It also shows information about
 * mouse events seen by an event filter on the screen object; the screen
 * gets to see most events before they are seen by the event target.
 */

public class SimpleTrackMouse extends Application {

    /**
     * The canvas that fills the window. The program reports about
     * mouse events for which the canvas is the target.
     */
    private Canvas canvas;

    /**
     * Contains a string with information about the event. This string
     ...
     * mouse events on the canvas. Also install an event filter for mouse events
     * on the screen. Information about mouse events will be displayed on
     * the canvas.
     */
    public void start( Stage stage ) {
         ...
         * shows how to handle the individual types of events. The response
     ...
     * information about the event on the canvas. It simply draws the eventInfo
     * string.
     */
    private void draw() {
    ...
    /**
     * Adds information about a mouse event on the canvas to the eventInfo
     * string, and displays that string on the canvas. The eventInfo string is
     * then cleared, except in the case of a Mouse Entered event ( otherwise,
     * the Mouse Entered event would always be immediately replaced by a Mouse
     * event before the user could have any chance of seeing it.
     */
