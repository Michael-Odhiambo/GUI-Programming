...
/**
 * This program simply demonstrates using a TextField and TextArea.
 */
public class TextInputDemo extends Application {

    /**
     * Define TextArea and TextField as instance variables so they can
     * be used throughout the program. Not needed in this program, but
     * fairly typical in more complex programs.
     */
    ...
    public void start( Stage stage ) {
        ...
        String content = "So, naturalists observe, a flea\n" +
        ...
        /**
         * A button that will clear the TextArea. It also selects all of the text
         * in the TextField and gives the focus to the TextField. If the user just
         * starts typing at that point, the old text will be deleted and replaced with
         * what the user types.
         */
        ...
        /**
         * Put the components in a BorderPane, which will be the root of the Scene.
         * A dark gray background on the BorderPane will show through in the margins around
         * the TextArea and TextField, and in the extra space in the bottom section
         * around the button.
         */
        ...
        BorderPane.setMargin( contentInput, new Insets(2) );
