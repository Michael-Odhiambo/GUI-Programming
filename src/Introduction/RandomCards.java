 ...
 * There is a button that the user can click to redraw the image
 * using new random cards.
 */
...
public class RandomCards extends Application {
    ...
    /**
     * Contains images of all of the cards. Cards are arranged in 5 rows
     * and 13 columns. Each of the first four rows contains the cards from
     * one suit, in numerical order. The first four rows contain clubs, diamonds,
     * hearts, and spades in that order. The fifth row contains two jokers and a
     * face-down card.
     */
    ...
    public void start( Stage stage ) {
        ...
        cardImages = new Image( "Introduction/cards.png" );

        canvas = new Canvas( 515, 163 );
    ...
    private void draw() {
        ...
        double sx, sy;  // Top left corner of the source rectangle in cardImages.
        double dx, dy;  // Top left corner of destination rectangle for card in the canvas.
