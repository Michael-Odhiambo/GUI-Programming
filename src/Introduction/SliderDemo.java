...
public class SliderDemo extends Application {
    ...
    private Label label;  // A label for reporting changes in the slider's values.
    ...
    public void start( Stage stage ) {
        ...
        slider3.setSnapToTicks( true );  // After user finishes drag, value is snapped to a tick mark; Since there are
        // minor tick marks at integer values, the slider value is snapped to an integer.
